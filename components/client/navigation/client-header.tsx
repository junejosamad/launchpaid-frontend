...
// components/client/navigation/client-header.tsx
"use client"

import { Bell, Menu, Search, User, ShoppingBag } from "lucide-react"
...
export function ClientHeader({ onMobileMenuToggle }: ClientHeaderProps) {
  return (
        ...
        <div className="flex items-center space-x-4">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56 bg-gray-800 border-gray-700" align="end">
              <DropdownMenuLabel className="text-white">Brand Account</DropdownMenuLabel>
